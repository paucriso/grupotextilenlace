    ...
    <div class="splide__track">
          <ul class="splide__list">
              ...
              <li class="splide__slide">
                ...
                <img src="{{asset('storage/images/slide_2.jpg')}}" alt="">
              </li>
              <li class="splide__slide">
                <div class="container mx-auto absolute left-0 top-0 right-0 bottom-0 flex flex-col items-start justify-center">
                  <h2 class="text-4xl text-azul-500 font-bold -mt-20">Grupo Textil Enlace Uniformes</h2>
                ...
                <img src="{{asset('storage/images/slide_3.jpg')}}" alt="">
              </li>
              <li class="splide__slide">
                <div class="container mx-auto absolute left-0 top-0 right-0 bottom-0 flex flex-col items-start justify-center">
                  <h2 class="text-4xl text-azul-500 font-bold -mt-20">Grupo Textil Enlace Uniformes</h2>
                ...
                <img src="{{asset('storage/images/slide_4.jpg')}}" alt="">
              </li>
          </ul>
    </div>
  </div>
...
{{-- <!-- Swiper -->
<div class="swiper mySwiper bg-violet-600">
