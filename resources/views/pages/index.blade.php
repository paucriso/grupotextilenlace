...
@include('partials.slider')
    ...
    <section class="py-8 bg-gray-100">
        <div class="container mx-auto px-8 lg:px-0">
            <h2 class="max-w-2xl mb-8 text-2xl lg:text-4xl font-bold leading-none tracking-tight text-center mx-auto text-azul-500">Grupo Textil Enlace: <span class="text-verde-500">Tu Destino para Prendas de Calidad</span></h2>
            <p class="font-light text-gray-500 md:text-lg lg:text-xl text-justify lg:max-w-[90%;] mx-auto mb-16">
            ...
            <div class="flex flex-col lg:flex-row justify-around uppercase text-azul-500">
                <div class="flex flex-col items-center justify-center text-xl font-semibold mb-6 lg:mb-0">
        ...
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">
                    Nos especializamos en la fabricación de ropa de mezclilla diseñada para soportar un
                    uso rudo. Utilizamos telas de la más alta calidad y resistencia, asegurando
                    durabilidad y comodidad en cada prenda. Nuestra atención al detalle y compromiso con
                    la excelencia garantizan que nuestros productos cumplan con las expectativas más
                    exigentes.
                </p>
            </div>
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                ...
                <div class="text-gray-500 sm:text-lg">
                    <h2 class="mb-4 text-2xl lg:text-3xl font-bold tracking-tight text-azul-500">Playeras en Variados Diseños y Colores</h2>
                    <p class="mb-8 font-light lg:text-xl">
                        Nos dedicamos a la fabricación de playeras de alta calidad, diseñadas para ofrecer comodidad y durabilidad. Utilizamos materiales premium y técnicas avanzadas para asegurar que cada prenda cumpla con los estándares más exigentes.
                    </p>
                    <!-- List -->
                    ...
                    <p class="font-light lg:text-xl">
                        Nuestro compromiso con la excelencia se refleja en cada detalle, desde el corte hasta el acabado, garantizando productos que satisfacen las necesidades de nuestros clientes.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="{{asset('storage/images/camisas-reflejantes.webp')}}"
                    alt="feature image 2">
                <div class="text-gray-500 sm:text-lg">
                    <h2 class="mb-4 text-2xl lg:text-3xl font-bold tracking-tight text-azul-500">Diseños de Indumentaria Industrial Personalizada</h2>
                    <p class="mb-8 font-light lg:text-xl">
                        Confeccionamos y personalizamos indumentaria de seguridad para la industria, utilizando telas de alta calidad para proporcionar a su empresa la imagen que merece, para que cumplas con los estándares de seguridad.
                    </p>
                    <!-- List -->
                    <ul role="list" class="pt-8 space-y-5 border-t border-gray-200 my-7">
                        <li class="flex space-x-3">
                    ...
                    <p class="font-light lg:text-xl">Envíanos el diseño que necesitas o elige los que tenemos para proponerte.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-[#f3f4f6] ">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                <h2 class="mb-4 text-2xl lg:text-3xl font-extrabold tracking-tight text-azul-500 ">
            ...
            <div>
                <img class="mx-auto hidden md:block" src="{{asset('storage/images/proceso.png')}}" alt="proceso de compra">
                <img class="mx-auto md:hidden" src="{{asset('storage/images/proceso-vertical.png')}}" alt="proceso de compra">
            </div>
    ...
    <section class="bg-gray-50 ">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div class="max-w-screen-sm mx-auto text-center">
                <svg class="mx-auto w-[90px] lg:w-[120px]" width="120px" height="120px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="#FEB901"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><title>ionicons-v5-s</title><polyline points="336 176 225.2 304 176 255.8" style="fill:none;stroke:#FEB901;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"></polyline><path d="M463.1,112.37C373.68,96.33,336.71,84.45,256,48,175.29,84.45,138.32,96.33,48.9,112.37,32.7,369.13,240.58,457.79,256,464,271.42,457.79,479.3,369.13,463.1,112.37Z" style="fill:none;stroke:#FEB901;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"></path></g></svg>
                <h2 class="mb-4 text-2xl lg:text-3xl font-extrabold leading-tight tracking-tight text-azul-500 ">Uniformes de la Mejor Calidad</h2>
